package com.eme22.floatingsearchview;
...
import com.eme22.floatingsearchview.util.adapter.GestureDetectorListenerAdapter;
import com.eme22.floatingsearchview.util.adapter.TextWatcherAdapter;
import com.eme22.floatingsearchview.util.view.MenuView;
import com.eme22.floatingsearchview.util.view.SearchInputView;
...
public class FloatingSearchView extends FrameLayout {
    ...
    private void setupSuggestionSection() {
        ...
        mSuggestionsList.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            @Override
