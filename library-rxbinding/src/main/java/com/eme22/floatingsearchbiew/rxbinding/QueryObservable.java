package com.eme22.floatingsearchbiew.rxbinding;
...
final public class QueryObservable extends InitialValueObservable<CharSequence> {
    ...
    @Override
    protected void subscribeListener(@androidx.annotation.NonNull Observer<? super CharSequence> observer) {
    ...
    final static class Listener extends MainThreadDisposable implements FloatingSearchView.OnQueryChangeListener, @NonNull Disposable {
